  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <motion.div
          whileHover={{ y: -5 }}
          className="bg-slate-800 rounded-lg p-5 border border-slate-700 shadow-lg"
        >
        ...
        <motion.div
          whileHover={region.storyProgress < 100 ? { y: -5 } : {}}
          className="bg-slate-800 rounded-lg p-5 border border-slate-700 shadow-lg"
        >
          ...
          <motion.button
            whileHover={region.storyProgress < 100 ? { scale: 1.02 } : {}}
            whileTap={region.storyProgress < 100 ? { scale: 0.98 } : {}}
      ...
      {region.storyProgress > 0 && !region.villainDefeated && (
        <motion.div
          ...
          className="bg-red-950/30 border border-red-900/50 rounded-lg p-5"
        >
